...
Host plugins pass a list of plugin definitions. Core checks whether each plugin is installed, active, and up to date, then renders a clean admin view with AJAX install/activate actions and an activity log.
