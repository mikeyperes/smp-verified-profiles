...
class Config {
    ...
    public static $plugin_version = "7.1.0";
...
function get_snippets( $type = '' ) {
    ...
    $snippets_admin = [
        ...
        [
            ...
            'requires_acf_structure' => 'verified-profile-manager-admin',
        ],
        [
        ...
        [
            ...
            'description'      => 'Applies the existing Profile Manager admin restrictions and redirects.',
            'info'             => '',
