...
function smp_vp_display_templates(): array {
    return [
        ...
        "newsroom" => [
            "label" => "Newsroom",
            "class" => "vp-f",
            "description" => "Compact monochrome sidebar list. Hairline rows, small bold sans name, uppercase role, dark verified badge, arrow only.",
        ],
    ];
}
