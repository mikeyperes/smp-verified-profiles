...
function smp_vp_display_templates(): array {
    return [
        ...
        "newsroom" => [
            "label" => "Newsroom",
            "class" => "vp-f",
            "description" => "Monochrome editorial card with a bold sans name, uppercase role, ink top rule, and dark verified badge.",
        ],
    ];
}
